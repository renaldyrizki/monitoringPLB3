...
@section('breadcrumbs')
    {!! Breadcrumbs::render('manifestControl') !!}
@endsection
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="filter" style="margin-top: 0.1in; margin-bottom: 0.1in;">
                    <form class="form-inline" action="{{ route('backend::manifestControl') }}" method="GET">
                        ...
                        <div class="form-group" row>
                            <input type="text" name="nomor_manifest" class="form-control form-control-sm" placeholder="Nomor Manifest" style="margin-left: 0; border-width: 1px;">
                        </div>
                        <div class="form-group" row>
                ...
                <div class="table-responsive m-t-20">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td>
                                <a class="btn btn-info btn-xs" title="Ubah" href="{{ route('backend::manifestControl_edit', ['id' => $res->id_pengangkutan]) }}"> Ubah
